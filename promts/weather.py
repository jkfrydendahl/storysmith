...
class WeatherPrompt(PromptTemplate):
    def render(self, phenomenon: str, severity: str, season: str, environment: str, genre: str) -> str:
        ...
        return (
            ...
            f"IMPORTANT: \n"
            f"- DO NOT give the weather event a proper name. Just describe it as what it is (e.g., 'severe spring squall', 'winter blizzard', 'summer thunderstorm').\n"
            f"- Ensure the weather's severity matches the specified level:\n"
            ...
            f"Current Conditions: [Describe the weather type and current state - temperature, precipitation, wind, visibility. Do not use a proper name.]\n\n"
